...
#define BATTERY_STATUS_BUTTON_Pin GPIO_PIN_7
#define BATTERY_STATUS_BUTTON_GPIO_Port GPIOA
#define BATTERY_OUTPUT_Pin GPIO_PIN_4
...
#define SHIFT_SRCLK_Pin GPIO_PIN_13
#define SHIFT_SRCLK_GPIO_Port GPIOB
#define SHIFT_NOT_SRCLK_Pin GPIO_PIN_14
#define SHIFT_NOT_SRCLK_GPIO_Port GPIOB
#define SHIFT_RCLK_Pin GPIO_PIN_15
#define SHIFT_RCLK_GPIO_Port GPIOB
#define SHIFT_NOT_OE_Pin GPIO_PIN_6
#define SHIFT_NOT_OE_GPIO_Port GPIOC
