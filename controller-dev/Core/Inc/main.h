...
#define SHIFT_SER_Pin GPIO_PIN_1
#define SHIFT_SER_GPIO_Port GPIOA
#define SHIFT_SRCLK_Pin GPIO_PIN_2
#define SHIFT_SRCLK_GPIO_Port GPIOA
#define SHIFT_NOT_SRCLK_Pin GPIO_PIN_3
#define SHIFT_NOT_SRCLK_GPIO_Port GPIOA
#define SHIFT_RCLK_Pin GPIO_PIN_4
#define SHIFT_RCLK_GPIO_Port GPIOA
#define SHIFT_NOT_OE_Pin GPIO_PIN_5
#define SHIFT_NOT_OE_GPIO_Port GPIOA
#define DEBUG_LED_Pin GPIO_PIN_6
#define DEBUG_LED_GPIO_Port GPIOA
#define BLUETOOTH_UART_TX_Pin GPIO_PIN_4
#define BLUETOOTH_UART_TX_GPIO_Port GPIOC
#define BLUETOOTH_UART_RX_Pin GPIO_PIN_5
#define BLUETOOTH_UART_RX_GPIO_Port GPIOC
#define BUZZER_Pin GPIO_PIN_1
#define BUZZER_GPIO_Port GPIOB
#define BATTERY_STATUS_BUTTON_Pin GPIO_PIN_2
#define BATTERY_STATUS_BUTTON_GPIO_Port GPIOB
#define BATTERY_OUTPUT_Pin GPIO_PIN_10
#define BATTERY_OUTPUT_GPIO_Port GPIOB
