...
#define PA5_FRONT_IMU_INT_Pin GPIO_PIN_5
#define PA5_FRONT_IMU_INT_GPIO_Port GPIOA
#define PA5_FRONT_IMU_INT_EXTI_IRQn EXTI4_15_IRQn
...
#define PB0_BACK_IMU_INT_Pin GPIO_PIN_0
#define PB0_BACK_IMU_INT_GPIO_Port GPIOB
#define PB0_BACK_IMU_INT_EXTI_IRQn EXTI0_1_IRQn
